...
self.__Monthly_KWH_Average = FigureCanvasTkAgg(OriginalDataSet=pd.read_csv('Energy_Usage_2010.csv'))
self.__Monthly_KWH_Average = tk.Canvas(OriginalDataSet=pd.read_csv('Energy_Usage_2010.csv'))
