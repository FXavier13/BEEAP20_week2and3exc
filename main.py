...
Monthly_KWH_Average = FigureCanvasTkAgg(OriginalDataSet=pd.read_csv('Energy_Usage_2010.csv'))
Monthly_KWH_Average = tk.Canvas(OriginalDataSet=pd.read_csv('Energy_Usage_2010.csv'))
Monthly_KWH_Average.place(x=50, y=130, width=234, height=140)
...
toolbar=NavigationToolbar2Tk(Monthly_KWH_Average,OriginalDataSet=pd.read_csv('Energy_Usage_2010.csv'))
